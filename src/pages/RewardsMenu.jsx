...
const RewardsMenu = () => {
  const rewardCategories = [
    {
      id: 1,
      title: "Employee Reward Points",
      description: "Manage Employee Reward points",
      icon: <FaGifts className="w-8 h-8" />,
      color: "from-blue-600 to-blue-700",
      lightColor: "bg-blue-50",
      borderColor: "border-blue-200",
      href: "/reward-menu/employee-reward-points",
      stats: "Employee Rewards Information",
    },
     {
      id: 2,
      title: "Customer Reward Points",
      description: "Manage Customer Reward points",
      icon: <FaGifts className="w-8 h-8" />,
      color: "from-blue-600 to-blue-700",
      lightColor: "bg-blue-50",
      borderColor: "border-blue-200",
      href: "/reward-menu/customer-reward-points",
      stats: "Customer Rewards Information",
    },
          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Manage and track Employee and Customer Rewards
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Use the Rewards Directory to manage employee, customer  and update reward information all in one place.</p>
              </div>
            </div>
          </div>
          </div>
