...
const HRSalaryManagement = () => {
  ...
  const confirmPayAsSalary = () => {
    ...
    // Calculate incentive using new formula
  ...
  const calculatedIncentive = useMemo(() => {
    ...
    const diff = (totalTarget - totalBusinessClosed) / 100;
...
// Calculate incentive using:

// rawIncentive = (totalTarget - totalBusinessClosed) / 100

// Rules

// If rawIncentive > 0

// calculatedIncentive = totalBusinessClosed / 100
...
// Only two buttons must exist

// Pay as Salary

// Pay as Incentive

// Both buttons should be visible only when calculatedIncentive > 0

// No UI redesign — do not change layout or styling significantly

// 3. Pay as Salary Flow
...
// Salary payable should include:

// salary_payable = attendance_salary + previous_month_remaining_balance + incentive


// 🚫 Incentive payable must NOT be updated

// 4. Pay as Incentive Flow
...
// Add calculated incentive to incentive_payable

// salary_payable must remain unchanged

// Attendance salary must NOT be added

// 🚫 Salary payable must NOT be updated

// 5. Modal & Payment Safety

// No payment logic should execute without modal confirmation

// “Salary Already Processed” modal must:

// Continue to work correctly

// Display all related salary, incentive, and balance data accurately

// 6. Previous Month Salary Integration

// Fetch previous month salary during salary calculation

// Backend salary calculation API must return:
...
//     calculated_salary,
//     remaining_balance: previousMonthResponse.remaining_balance
//   }
// });


// remaining_balance must:

// Be shown in a read-only input field

// Be added to salary_payable when Pay as Salary is confirmed

// salary_payable field must always be visible

// 7. Final Constraints

// Incentive is added only when “Pay as Incentive” is confirmed

// Salary and Incentive must never be added together
