          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Manage and view payment-In payment-Out information 
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {paymentMenuCategories.map((category) => (
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-700">Use the Payment-In directory to manage payment-in transaction details and update payment information all in one place.</p>
                <p className="text-slate-700">Use the Payment-Out directory to manage payment-out transaction details and update payment information all in one place.</p>
