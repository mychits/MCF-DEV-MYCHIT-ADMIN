...
const DueWhatsappMessageMenu = () => {
  const duewhatsappCategories = [
    ...
    //   target:"_self",
      stats: "Outstanding Whatsapp Message",
    },
     {
      id: 2,
      title: " Outstanding [Over Due] Whatsapp",
      description: "Outstanding [Over Due] Whatsapp",
      icon: <FaWhatsapp className="w-8 h-8" />,
      color: "from-blue-600 to-blue-700",
      lightColor: "bg-blue-50",
      borderColor: "border-blue-200",
    ...
    //   target:"_self",
      stats: "Outstanding [Over Due] Whatsapp Message",
    },
        ...
        <div className="flex-1">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {duewhatsappCategories.map((category) => (
...
export default DueWhatsappMessageMenu;
